...
describe.only('migrations', () => {
  ...
  it('should return 1 required migration if stored version is 1.0.0', async function () {
    expect((await SNMigrationService.getRequiredMigrations('1.0.0')).length).to.equal(1);
  });

  it('should return 0 required migrations if stored version is 2.0.0 or 2.0.1', async function () {
