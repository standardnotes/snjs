export { SNCryptoManager, cryptoManager }  from '@Crypto/manager';
...
export { SFAbstractCrypto } from './crypto/lib/abstract_crypto';
export { SFCryptoWeb } from './crypto/lib/webcrypto';
export { SFCryptoJS } from './crypto/lib/cryptojs';
