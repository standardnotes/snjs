...
import { EncryptionIntentFile, EncryptionIntentFileDecrypted } from '@Protocol/intents';
...
export class SFModelManager {
  ...
  */
  ...
  async getJSONDataForItems(items, keyParams, returnNullIfEmpty) {
    const intent = keyParams ? EncryptionIntentFile : EncryptionIntentFileDecrypted;
