...
export class SFPrivilegesManager {
  ...
  constructor(modelManager, syncManager, singletonManager) {
    ...
    SFPrivilegesManager.ActionUseDecryptedActions = "ActionUseDecryptedActions";
    ...
    this.availableActions = [
      ...
      SFPrivilegesManager.ActionUseDecryptedActions,
    ]
  ...
  */
  ...
  async loadPrivileges() {
    ...
    this.loadPromise = new Promise((resolve, reject) => {
      ...
      this.singletonManager.registerSingleton([contentTypePredicate], (resolvedSingleton) => {
        ...
        if(!protocolManager.crypto.generateUUIDSync) {
  ...
  displayInfoForAction(action) {
    ...
    metadata[SFPrivilegesManager.ActionUseDecryptedActions] = {
      label: "Use Decrypted Actions"
    }
