...
export const PRIVILEGE_ACTION_MANAGE_EXTENSIONS    = 'ActionManageExtensions';
export const PRIVILEGE_ACTION_MANAGE_BACKUPS       = 'ActionManageBackups';
export const PRIVILEGE_ACTION_VIEW_PROTECTED_NOTES = 'ActionViewProtectedNotes';
export const PRIVILEGE_ACTION_MANAGE_PRIVILEGES    = 'ActionManagePrivileges';
export const PRIVILEGE_ACTION_MANAGE_PASSCODE      = 'ActionManagePasscode';
export const PRIVILEGE_ACTION_DELETE_NOTE          = 'ActionDeleteNote';
...
export class PrivilegesManager extends PureService {
  constructor({
    modelManager,
    syncManager,
    singletonManager,
