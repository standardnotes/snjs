...
export class SNMigrationService extends PureService {
  ...
  deinit() {
    ...
    if(this.removeAppObserver) {
      this.removeAppObserver();
      this.removeSyncObserver();
      this.removeAppObserver = null;
  ...
  */
  ...
  /** @access private */
  addLoginObserver() {
   this.removeAppObserver = this.application.addEventObserver(async (event, data) => {
  ...
  /** @access private */
  addSyncObserver() {
   this.removeSyncObserver = this.application.syncService.addEventObserver(async (event, data) => {
