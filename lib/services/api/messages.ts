...
export const UNSUPPORTED_KEY_DERIVATION             = `Your account was created on a platform with higher security
...
export function StrictSignInFailed(current: ProtocolVersion, latest: ProtocolVersion) {
  return `
          ...
          version of ${current} for your account. If you'd like to proceed
