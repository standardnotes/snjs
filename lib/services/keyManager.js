...
const ITEM_KEY_CONTENT_TYPE        = 'SN|ItemKey';
const ROOT_KEY_CONTENT_TYPE        = 'SN|RootKey|NoSync';
const WRAPPED_ROOT_KEY = "WRAPPED_ROOT_KEY";
const WRAPPED_ROOT_KEY_KEY_PARAMS = "WRAPPED_ROOT_KEY_KEY_PARAMS";
...
export class SNKeyManager {
  ...
  */
   ...
   */
  async saveRootKey(key) {
    if(key.constructor.name !== ITEM_KEY_CONTENT_TYPE) {
      throw `Root key must be a ${ROOT_KEY_CONTENT_TYPE} object.`;
    }
    const rootValues = key.rootValues();
