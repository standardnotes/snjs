...
export class SNStorageManager extends PureService {
  ...
  isStorageWrapped() {
    ...
    return !isNullOrUndefined(wrappedValue);
  }
  ...
  async decryptStorage() {
    ...
    await this.notifyEvent(SERVICE_EVENT_STORAGE_DECRYPTED);
  }
  ...
  defaultValuesObject({wrapped} = {}) {
    return this.constructor.defaultValuesObject({wrapped});
  }

  static defaultValuesObject({wrapped = {}} = {}) {
    return {
      [STORAGE_VALUES_KEY_WRAPPED]: wrapped,
      [STORAGE_VALUES_KEY_UNWRAPPED]: {},
      [STORAGE_VALUES_KEY_NONWRAPPED]: {}
    }
  }
