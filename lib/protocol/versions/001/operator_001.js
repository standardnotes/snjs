...
import {
  CreateEncryptionParameters, CopyEncryptionParameters, PayloadFields, PayloadFormats
} from '@Payloads';
import { SNRootKey, ProtocolVersions } from '@Protocol';
...
export class SNProtocolOperator001 extends SNProtocolOperator {
  ...
  async createRootKey({ identifier, password }) {
    ...
    const keyParams = new SNRootKeyParams001({
      pw_nonce: pwNonce,
      pw_cost: pwCost,
      pw_salt: pwSalt,
      email: identifier
