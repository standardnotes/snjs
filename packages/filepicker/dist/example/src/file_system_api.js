...
var FileSystemApi = /** @class */ (function () {
    function FileSystemApi(application) {
        var _this = this;
        this.application = application;
        this.uploadFile = function () { return __awaiter(_this, void 0, void 0, function () {
            var operation, picker, fileResult, fileObj;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.application.fileService.beginNewFileUpload()];
                    case 1:
                        operation = _a.sent();
                        picker = new filepicker_1.StreamingFilePicker();
                        return [4 /*yield*/, picker.selectFileAndStream(function (chunk, index, isLast) {
        ...
        this.downloadFile = function () { return __awaiter(_this, void 0, void 0, function () {
            var file, picker, _a, pusher, closer;
            var _this = this;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        file = this.application['itemManager']
                            ...
                            .find(function (file) { return file.remoteIdentifier === _this.remoteIdentifier; });
                        picker = new filepicker_1.StreamingFilePicker();
                        return [4 /*yield*/, picker.saveFile()];
                    case 1:
                        _a = _b.sent(), pusher = _a.pusher, closer = _a.closer;
                        return [4 /*yield*/, this.application.fileService.downloadFile(file, function (decryptedBytes) {
                                ...
                                pusher(decryptedBytes);
                            })];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, closer()];
                    case 3:
                        _b.sent();
    ...
    Object.defineProperty(FileSystemApi.prototype, "downloadButton", {
        get: function () {
    ...
    FileSystemApi.prototype.configureDownloadButton = function () {
        this.downloadButton.onclick = this.downloadFile;
        this.downloadButton.style.display = 'none';
    };
    FileSystemApi.prototype.configureFilePicker = function () {
        var button = document.getElementById('fileSystemUploadButton');
