...
exports.SQSNewRelicEventMessageHandler = void 0;
const zlib = require("zlib");
const newrelic = require("newrelic");
class SQSNewRelicEventMessageHandler {
    ...
    handleMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield newrelic.startBackgroundTransaction(domainEvent.type, 
...
exports.SQSNewRelicEventMessageHandler = SQSNewRelicEventMessageHandler;
