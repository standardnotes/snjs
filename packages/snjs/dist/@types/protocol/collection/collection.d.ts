...
export declare class MutableCollection<T extends PurePayload | SNItem> {
     ...
     */
    findAll(uuids: UuidString[], includeBlanks?: boolean): T[];
    ...
    elementsReferencingElement(element: T, contentType?: ContentType): T[];
    uuidReferencesForUuid(uuid: UuidString): string[];
