...
export declare class PayloadsDelta {
    ...
    protected readonly relatedCollectionSet?: ImmutablePayloadCollectionSet | undefined;
     ...
     */
    constructor(baseCollection: ImmutablePayloadCollection, applyCollection: ImmutablePayloadCollection, relatedCollectionSet?: ImmutablePayloadCollectionSet | undefined, historyMap?: Record<string, import("../../..").HistoryEntry[]> | undefined);
