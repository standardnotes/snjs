...
export declare class SNItem {
    ...
    get content_type(): import("@standardnotes/common/dist/Domain/Content/ContentType").ContentType;
    get created_at(): Date;
    /**
     * The date timestamp the server set for this item upon it being synced
     * Undefined if never synced to a remote server.
     */
    get serverUpdatedAt(): Date | undefined;
...
export declare class ItemMutator {
    ...
    unsafe_setCustomContent(content: PayloadContent): void;
    setDeleted(): void;
    set lastSyncBegan(began: Date);
    set errorDecrypting(errorDecrypting: boolean);
    set updated_at(updated_at: Date);
    set updated_at_timestamp(updated_at_timestamp: number);
    ...
    setAppDataItem(key: AppDataField | PrefKey, value: any): void;
