...
export declare function getGlobalScope(): Window | unknown | null;
 ...
 */
export declare function isEmpty(string: string): boolean;
/**
 ...
 */
export declare function uniqCombineObjArrays<T>(arrayA: T[], arrayB: T[], equalityKeys: (keyof T)[]): T[];
/**
 ...
 * @returns Array containing unique values
 */
export declare function uniqueArrayByKey<T>(array: T[], key: keyof T): T[];
/**
 ...
 */
export declare function filterFromArray<T>(array: T[], predicate: Partial<Record<keyof T, any>> | ((object: T) => boolean)): void;
/**
...
export declare function assertUnreachable(uncheckedCase: never): never;
/**
 ...
 */
export declare function naturalSort<T extends AnyRecord>(items: T[], property: keyof T, direction?: 'asc' | 'desc'): T[];
export declare function arraysEqual<T>(left: T[], right: T[]): boolean;
export declare function convertTimestampToMilliseconds(timestamp: number): number;
export declare function isErrorObject(object: any): object is ErrorObject;
export declare function sanitizeHtmlString(html: string): string;
export declare function dateToLocalizedString(date: Date): string;
export declare function nonSecureRandomIdentifier(): string;
export declare function log(instance: any, message: string, ...args: unknown[]): void;
