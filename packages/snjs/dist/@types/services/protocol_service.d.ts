...
import { AnyKeyParamsContent, KeyParamsOrigination, SNRootKeyParams } from './../protocol/key_params';
...
export declare class SNProtocolService extends PureService implements EncryptionDelegate {
    ...
    constructor(itemManager: ItemManager, payloadManager: PayloadManager, deviceInterface: DeviceInterface, storageService: SNStorageService, identifier: ApplicationIdentifier, crypto: SNPureCrypto);
    /** @override */
    deinit(): void;
     ...
     */
    getEncryptionDisplayName(): Promise<string | undefined>;
    /**
     ...
     */
    costMinimumForVersion(version: ProtocolVersion): number;
     ...
     */
    createBackupFile(intent: EncryptionIntent): Promise<BackupFile>;
    /**
     ...
     */
    defaultItemsKeyForItemVersion(version: ProtocolVersion, fromKeys?: SNItemsKey[]): SNItemsKey | undefined;
    /**
     ...
     */
    needsNewRootKeyBasedItemsKey(): boolean;
    /**
     ...
     */
    createNewDefaultItemsKey(): Promise<SNItemsKey>;
