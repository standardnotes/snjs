...
export declare class SNActionsService extends PureService {
    ...
    constructor(itemManager: ItemManager, alertService: SNAlertService, deviceInterface: DeviceInterface, httpService: SNHttpService, payloadManager: PayloadManager, protocolService: SNProtocolService, syncService: SNSyncService);
    /** @override */
    deinit(): void;
