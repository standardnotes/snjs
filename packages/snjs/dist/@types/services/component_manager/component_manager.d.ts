...
import { ComponentArea, ComponentPermission, SNComponent } from '../../models/app/component';
import { Environment, Platform } from '../../platforms';
import { UuidString } from '../../types';
import { PermissionDialog, DesktopManagerInterface } from './types';
...
export declare class SNComponentManager extends PureService<ComponentManagerEvent, EventData> {
    ...
    promptForPermissionsWithTimeout(component: SNComponent, permissions: ComponentPermission[], callback: (approved: boolean) => Promise<void>): void;
