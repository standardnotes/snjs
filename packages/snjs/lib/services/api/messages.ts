...
export const UPGRADING_ENCRYPTION =
  "Upgrading your account's encryption version…";
...
export const MFA_DISABLE_ERROR =
  'An error occurred while trying to disable multi-factor authentication. Please try again.';

export const AUTH_METHODS_ERROR =
  'An error occurred while trying to fetch authentication methods. Please try again.';
